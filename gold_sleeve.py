...
TOTAL_RISK_PCT = 0.04         # 4% equity risk (Basket Leg 2)
HARD_STOP_PRICE = 4250.0      # Hard stop above recent MAs
KILL_SWITCH_USD = -35000.0    # Allocated kill switch for Gold
MAGIC_GOLD = 20260704
...
def run_gold_sleeve():
    ...
    if state["cumulative_pnl"] <= KILL_SWITCH_USD:
        print("💀 KILL SWITCH TRIPPED. Gold sleeve halted forever.")
        return
